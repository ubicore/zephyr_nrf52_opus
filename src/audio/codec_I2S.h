...
typedef struct
{
	u16_t buff[CONFIG_AUDIO_FRAME_SIZE_SAMPLES*CONFIG_CHANNELS_RX];
	s32_t timestamp_I2S_Out;
} PCM_Rx_t;

typedef struct
{
	u16_t buff[CONFIG_AUDIO_FRAME_SIZE_SAMPLES*CONFIG_CHANNELS_TX];
	timestamp_player_t timestamp_play;
} PCM_Tx_t;
